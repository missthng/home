...
<html lang="en">
  ...
  <head>
    ...
    <link href="stylesheets/15-registration-page-2.css" media="screen" rel="stylesheet" type="text/css" />
...
-->
    <title>15) Registration page 2</title>
  </head>
...
<i class="icon icon-search"></i>
        ...
        <div class="paragraph paragraph-7">
          <p>Memberships&nbsp;give&nbsp;the user unlimited usage of New Zealand Trader with no hidden costs (No listing, buying or success fees) Minimum 3&nbsp;month membership. Cancel anytime.</p>
        </div>
        <img class="image image-2" src="images/advertise-here-8.gif">
        <div class="image image-3">
          <label class="checkbox checkbox-2">
            <input type="checkbox" value="" name="">
            <span>Charge my card $21.60 per annum&nbsp;</span>
          </label>
          <div class="paragraph">
            <p>(Save 10%)</p>
          </div>
          <label class="checkbox checkbox-1 checkbox-3">
            <input type="checkbox" value="" name="">
            <span>Charge my card $12 per 6 months</span>
          </label>
          <label class="checkbox checkbox-1 checkbox-4">
            <input type="checkbox" value="" name="">
            <span>Charge my card $6 per 3 months</span>
          </label>
          <button class="btn">Submit</button>
        </div>
        <img class="image image-4" src="images/download-87-2.jpg">
      </div>
    </div>
  </body>
