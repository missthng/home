...
<html lang="en">
  ...
  <head>
    ...
    <link href="stylesheets/1-thank-you-your-listing-has-been-created.css" media="screen" rel="stylesheet" type="text/css" />
...
-->
    <title>1) Thank you your listing has been created</title>
  </head>
  
  <body>
    <div id="page-wrapper">
      <div id="absolute-wrapper">
        <a class="dom-link dom-link-2" href="#">Add others and receive 1 month membership FREE</a>
...
<i class="icon icon-home"></i>
        ...
        <h1 class="dom-heading dom-heading-2">My Trader</h1>
...
<i class="icon icon-search"></i>
        ...
        <div class="image image-2">
          ...
          <div class="paragraph paragraph-2 paragraph-7">
            <p>Your listing is under the following category:</p>
          </div>
          <div class="paragraph paragraph-2 paragraph-8">
            <p>Cars &gt; Parts &gt; Gear Box</p>
          </div>
          <div class="paragraph paragraph-1 paragraph-9">
            <p>Auction:</p>
          </div>
          <a class="dom-link dom-link-1" href="#">#PA4584631</a>
        </div>
        <div class="alert">
          <button type="button" class="btn close">x</button> <strong>Alert!</strong>&nbsp;You have one new offer</div>
        <a class="dom-link dom-link-1 dom-link-3" href="#">View</a>
        <a class="dom-link dom-link-4" href="#"></a>
        <div class="well"></div>
        ...
        <img class="image image-3" src="images/bird-3.png">
        <a class="dom-link dom-link-1 dom-link-5" href="#">Offers (1)</a>
        ...
        <div class="paragraph paragraph-2 paragraph-10">
          <p>Would it be possible to have him fly from the top (Logo) to down here and &nbsp;the speech bubble pops out when he lands? &nbsp;A bit out there but thought I'd ask as it would be very cool. Lets make it happen!! xo</p>
        </div>
      </div>
    </div>
  </body>
